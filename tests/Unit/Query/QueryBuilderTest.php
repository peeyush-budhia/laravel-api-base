...
final class QueryBuilderTest extends TestCase
{
    ...
    public function test_it_adds_an_id_tie_breaker_to_sorted_queries(): void
    {
        $definition = new GenericQueryDefinition(
            sortable: ['first_name'],
        );
    ...
    public function test_it_orders_by_id_when_no_sort_is_requested(): void
    {
        $query = app(QueryBuilder::class)->apply(
            User::query(),
            new QueryParameters,
    ...
    public function test_it_rejects_unsupported_sorting(): void
    {
        User::factory()->create([
            'first_name' => 'Zack',
        ]);
